    ...
    for item in evidence_items:
        ...
        builder.add_node(
            ...
            properties={
                ...
                "source_scope": _field(item, "source_scope"),
                "document_id": _field(item, "document_id"),
                "section_id": _field(item, "section_id"),
                "section_label": _field(item, "section_label"),
                "page_number": _field(item, "page_number"),
                "char_start": _field(item, "char_start"),
                "char_end": _field(item, "char_end"),
                "source_hash": _field(item, "source_hash"),
